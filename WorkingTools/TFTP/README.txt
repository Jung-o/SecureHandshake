...
3. Commands:
   java TFTPClient [shpUsername] [shpPwd] [host] [shpPort] [Request Type] [Filename] (mode)
...
Download(read) file using octet mode:
   java TFTPClient user@email.com password 127.0.0.1 1337 R server1.jpg

Download(read) file using ascii mode:
   java TFTPClient user@email.com password 127.0.0.1 1337  R server2.txt netascii

Upload(write) file using octet mode:
   java TFTPClient user@email.com password 127.0.0.1 1337  W client1.jpg
   
Upload(write) file using octet mode
   java TFTPClient user@email.com password 127.0.0.1 1337  W client2.pdf
...
2. Compile all the .java files using “javac *.java”. 
3. Run the server using “java TFTP TFTPServer [shpPort]”， then server will start and listen to port 6969.
